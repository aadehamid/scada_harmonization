...
def tiny_tep_wide_n(n_samples: int, n_value_columns: int) -> pl.DataFrame:
...
def tiny_iiot_wide() -> pl.DataFrame:
...
def tiny_iiot_wide_no_time() -> pl.DataFrame:
